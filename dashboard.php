...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            .table img {
                width: 80px; /* Adjust image size on smaller screens */
            }
        }
    </style>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="carImages/<?php echo $car['image']; ?>" width="100px"></td>
                                    <td><?php echo $car['name']; ?></td>
                                    <td><?php echo $car['brand']; ?></td>
                                    <td><?php echo $car['price']; ?></td>
                                    <td>
                                        <a href="editCar.php?id=<?php echo $car['id']; ?>" class="btn btn-primary">Edit</a> |
                                        <a href="deleteCar.php?id=<?php echo $car['id']; ?>" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
